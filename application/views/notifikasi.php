                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 30px;font-family:'Lato',sans-serif;" align="left">
                                                            <div style="color: #7d7d7d; line-height: 120%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 120%; font-size: 14px;"><span style="font-size: 14px; line-height: 16.8px;">Silahkan login untuk menindaklanjuti!</span></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 30px;font-family:'Lato',sans-serif;" align="left">
                                                            <div style="color: #7d7d7d; line-height: 120%; text-align: center; word-wrap: break-word;">
                                                                <a class="button" href="<?= base_url('auth') ?>" target="_blank"><span style="color: #fff;">Login</span></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
